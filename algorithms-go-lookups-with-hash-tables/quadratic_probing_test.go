...
func TestQuadraticProbingHashTable(t *testing.T) {
	employees := []Employee{
	...
	ht := NewQuadraticProbingHashTable(10)
...
func TestQuadraticProbingHashTable_Probe(t *testing.T) {
	employees := []Employee{
		{"Ann Archer", "202-555-0101", false},
		{"Bob Baker", "202-555-0102", false},
		{"Cindy Cant", "202-555-0103", false},
...
func TestQuadraticProbingHashTable_Big(t *testing.T) {
